                    ...
                    <li class="treeview">
                      ...
                      <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                          ...
                          <li><a href="{{route('orders.index')}}"><i class="icon-Commit"><span class="path1"></span><span class="path2"></span></i>Manage transaction</a></li>
                        </ul>
                      </li>
            </div>
          </div>
				...
				<div class="col-lg-6 col-12">
					  <div class="box">
						<div class="box-header with-border">
						  <h4 class="box-title">Add transaction</h4>
						...
						<!-- /.box-header -->
                         ...
                         @csrf
                            ...
                            @endif
								<h4 class="box-title text-info mb-0"><i class="ti-user me-15"></i> Add transaction</h4>
								...
								<div class="row">
								  ...
								  <div class="col-md-6">
									<div class="form-group">
									  <label class="form-label">Add transaction</label>
									  <input type="text" class="form-control" name="add_transaction" placeholder="add_transaction" value={{old('add_transaction')}}>
									</div>
								  </div>
								</div>
