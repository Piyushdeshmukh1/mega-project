	  ...
	  <div class="container-full">
		...
		<div class="content-header">
			<div class="d-flex align-items-center">
				<div class="me-auto">
					<h4 class="page-title">Transactions Data Tables</h4>
			...
			<div class="col-12">
				<div class="box">
                    ...
                    <tr>
                        ...
                        <td>{{$transaction->add_transaction}}</td>

                        <td>
                              <a href="{{route('transactions.edit',$transaction->id)}}"><button type="button" class="btn btn-outline-primary">Edit</button>



                         <a href="{{route('transactions.delete',$transaction->id)}}"><button type="button" class="btn btn-outline-primary">Delete</button>
