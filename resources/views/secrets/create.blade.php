				...
				<div class="col-lg-6 col-12">
					  <div class="box">
						<div class="box-header with-border">
						  <h4 class="box-title">Add secret</h4>
						...
						<!-- /.box-header -->
                         ...
                         @csrf
                            ...
                            @endif
								<h4 class="box-title text-info mb-0"><i class="ti-user me-15"></i> Add secret</h4>
								...
								<div class="row">
								  ...
								  <div class="col-md-6">
									<div class="form-group">
									  <label class="form-label">Add slug</label>
									  <input type="text" class="form-control" name="add_slug" placeholder="add_slug" value={{old('add_slug')}}>
									</div>
								  </div>
								</div>
                                  <button type="Submit" class="btn btn-success">Add new secret</button>
