	  ...
	  <div class="container-full">
		...
		<div class="content-header">
			<div class="d-flex align-items-center">
				<div class="me-auto">
					<h4 class="page-title">Secrets Data Tables</h4>
		  ...
		  <div class="row">
			...
			<div class="col-12">
				<div class="box">
                    ...
                    <tr>
                        <td>{{$secret->name}}</td>
                        <td>{{$secret->add_slug}}</td>

                        <td>
                              <a href="{{route('secrets.edit',$secret->id)}}"><button type="button" class="btn btn-outline-primary">Edit</button>
                              </a>

                        <a href="{{route('secrets.delete',$secret->id)}}"><button type="button" class="btn btn-outline-primary">Delete</button>
                        </a> </td>
