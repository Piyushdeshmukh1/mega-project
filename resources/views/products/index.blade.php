	  ...
	  <div class="container-full">
		...
		<div class="content-header">
			<div class="d-flex align-items-center">
				<div class="me-auto">
					<h4 class="page-title"> Product Data Tables</h4>
					...
					<div class="box-body">
						<div class="table-responsive">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('product.edit',$product->id)}}"><button type="button" class="btn btn-outline-primary">Edit</button></a>



                                    <a href="{{route('product.delete',$product->id)}}"><button type="button" class="btn btn-outline-primary">Delete</button>
                                    </a>
                                </td>
