					  ...
					  <div class="box">
						...
						<!-- /.box-header -->
                         ...
                         @csrf
                            ...
                            @endif
								<h4 class="box-title text-info mb-0"><i class="ti-user me-15"></i> Add role</h4>
								...
								<div class="row">
								  ...
								  <div class="col-md-6">
									<div class="form-group">
									  ...
									  <input type="text" class="form-control" name="slug_name" placeholder="slug_name" value={{old('slug_name')}}>
									</div>
								  </div>
								</div>
								<div class="row">
                                ...
                                <label class="form-label">Secret_code</label>
