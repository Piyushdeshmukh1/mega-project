					  ...
					  <div class="box">
						...
						<!-- /.box-header -->
                         ...
                         @csrf
                            ...
                            @endif
								<h4 class="box-title text-info mb-0"><i class="ti-user me-15"></i> Add post</h4>
								...
								<div class="row">
								  <div class="col-md-6">
									<div class="form-group">
									  ...
									  <input type="text" class="form-control" name="Title" placeholder="title" value={{old('nTitleame')}}>
									</div>
								  </div>
                                  <div class="col-md-6">
                                  <div class="form-group">
								  ...
								  {{-- <div class="col-md-6">
									<div class="form-group">
									  ...
									  <input type="text" class="form-control" name="add_post" placeholder="add_post" value={{old('add_post')}}>
									</div>
								  </div> --}}
								 </div>
