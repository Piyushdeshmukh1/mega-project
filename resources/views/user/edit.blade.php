                ...
                <ul class="sidebar-menu" data-widget="tree">
                    <li>
                        {{-- <a href="appointments.html"> --}}
                            <li><a href="{{route('users.dash')}}"><i data-feather="monitor"></i><span>Dashboard</span></a></li>
                        </a>
                      </li>
								...
								<div class="row">
								  ...
								  <div class="col-md-6">
									<div class="form-group">
									  ...
									  <input type="text" class="form-control" name="email" email="text" placeholder="email">
									</div>
								  </div>
								</div>
								<div class="row">
								  ...
								  <div class="col-md-6">
									<div class="form-group">
									  ...
									  <input type="text" class="form-control" name="contact_number" placeholder="contact_number">
									</div>
								  </div>
								</div>
