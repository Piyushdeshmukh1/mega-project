			...
			<div class="d-flex align-items-center">
				<div class="me-auto">
					...
					<div class="d-inline-block align-items-center">
                        ...
                        @endif
							 <ol class="breadcrumb">
								<li class="breadcrumb-item"><a href="#"><i class="mdi mdi-home-outline"></i>User</a></li>
				...
				<div class="col-lg-6 col-12">
					  <div class="box">
						...
						<form action="{{route('users.store')}}" method="POST">
                            ...
                            @endif
								<h4 class="box-title text-info mb-0"><i class="ti-user me-15"></i> Add User</h4>
								...
								<div class="row">
								  ...
								  <div class="col-md-6">
									<div class="form-group">
									  ...
									  <input type="text" class="form-control" name="email" email="text" placeholder="email" value={{old('email')}}>
									</div>
								  </div>
								</div>
								<div class="row">
								  ...
								  <div class="col-md-6">
									<div class="form-group">
									  ...
									  <input type="text" class="form-control" name="contact_number" placeholder="contact_number" value={{old('contact_number')}}>
									</div>
								  </div>
								</div>

                                <label class="form-label">Address</label>
								  <input type="text" class="form-control" name="address" placeholder="address"  value={{old('address')}}><br>
                                  <label class="form-label">Pin</label>
                                  <input type="text" class="form-control" name="pin" placeholder="pincode"  value={{old('pincode')}}><br>
                                  <input type="text" class="form-control" name="select_country" placeholder="select country" value={{old('select_country')}}><br>
                                  <input type="text" class="form-control" placeholder="select state" name="select_state"  value={{old('select_state')}}><br>
                                  <input type="text" class="form-control" placeholder="select city" name="select_city"  value={{old('select_city')}}><br>
