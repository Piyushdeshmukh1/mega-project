	  ...
	  <div class="container-full">
		...
		<div class="content-header">
			<div class="d-flex align-items-center">
				<div class="me-auto">
					<h4 class="page-title"> User Data Tables</h4>
			...
			<div class="col-12">
				<div class="box">
                    ...
                    <tr>
                        ...
                        <td>{{$user->address}}</td>
                        <td>{{$user->pin}}</td>
                        <td>{{$user->select_country}}</td>
                        <td>{{$user->select_state}}</td>
                        <td>{{$user->select_city}}</td>
                        <td>
                             <a href="{{route('user.edit',$user->id)}}"><button type="button" class="btn btn-outline-primary">Edit</button>


                        <a href="{{route('user.delete',$user->id)}}"><button type="button" class="btn btn-outline-primary">Delete</button>
                       </td>
