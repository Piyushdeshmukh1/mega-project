	  ...
	  <div class="container-full">
		...
		<div class="content-header">
			<div class="d-flex align-items-center">
				<div class="me-auto">
					<h4 class="page-title">Orders Data Tables</h4>
			...
			<div class="col-12">
				<div class="box">
                    ...
                    <tr>
                        ...
                        <td>
                              <a href="{{route('orders.edit',$order->id)}}"><button type="button" class="btn btn-outline-primary">Edit</button>
                              </a>

                        <a href="{{route('orders.delete',$order->id)}}"><button type="button" class="btn btn-outline-primary">Delete</button>
                        </a> </td>
