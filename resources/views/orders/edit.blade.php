					  ...
					  <div class="box">
						...
						<!-- /.box-header -->
                         ...
                         @csrf
                            ...
                            @endif
								<h4 class="box-title text-info mb-0"><i class="ti-user me-15"></i> Add order</h4>
								...
								<div class="row">
								  ...
								  <div class="col-md-6">
									<div class="form-group">
									  <label class="form-label">Add order</label>
									  <input type="text" class="form-control" name="add_order" placeholder="add_order" value={{old('add_order')}}>
									</div>
								  </div>
								</div>
