		...
		<section class="content">
			<div class="row">
				<div class="col-xl-8 col-12">
						...
						<div class="col-xl-3 col-md-6 col-6">
							<div class="box">
								<div class="box-body text-center">
									...
									<p class="text-fade mt-15 mb-5">Total Roles</p>
									<h2 class="mt-0">{{$role}}</h2>
								</div>
							</div>
						</div>
						<div class="col-xl-3 col-md-6 col-6">
					...
					<div class="row">
									...
									<div class="inner-user-div2">
										...
										<div>
											...
											<div class="d-flex justify-content-between align-items-end mb-15 py-10 bb-dashed border-bottom">
												<div>
													 <p class="mb-0 text-muted"><i class="fa fa-clock-o"></i>{{$user->created_at->format('d-m')}}</p>
												</div>
												<div>
													<div class="dropdown">
										...
										<div>
											<div class="d-flex justify-content-between align-items-end">
												<div>
													...
													{{-- <h5 class="my-5"> Product History</h5> --}}
												</div>
												<div>
						...
						{{-- <div class="col-xl-6 col-12">
							<div class="box">
								<div class="box-header">
									<h4 class="box-title">Orders History</h4>
								</div>
									...
									<div class="inner-user-div">
									  ...
									  <div class="media-list bb-1 bb-dashed border-light">
										<div class="media align-items-center">
										  ...
										  <div class="media-body">
											<p class="fs-16">
											  <a class="hover-primary" href="#">Piyush D</a>
											</p>
				...
				<div class="col-xl-4 col-12">
					<div class="box">
						<div class="box-header">
							<h4 class="box-title">Product History</h4>
						</div>
						<div class="box-body">
							...
							<div class="inner-user-div4">
								...
								<div>
									<div class="d-flex align-items-center mb-10">
										...
										<div class="d-flex flex-column flex-grow-1 fw-500">
											 <p class="hover-primary text-fade mb-1 fs-14">{{$product->name}}</p>
									...
									<div class="d-flex justify-content-between align-items-end mb-15 py-10 bb-dashed border-bottom">
										<div>
											  <p class="mb-0 text-muted"><i class="fa fa-clock-o me-5"></i>{{$product->created_at->format('d-m-y')}}<span class="mx-20"></span></p>
										</div>
										<div>
											 <div class="dropdown">
