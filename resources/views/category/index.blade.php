	  ...
	  <div class="container-full">
		...
		<div class="content-header">
			<div class="d-flex align-items-center">
				<div class="me-auto">
					<h4 class="page-title">Category Data Tables</h4>
				...
				<div class="box">
                    ...
                    <tr>
                        ...
                        <td>{{$category->status}}</td>
                         ...
                         <td>
                              <a href="{{route('category.edit',$category->id)}}"><button type="button" class="btn btn-outline-primary">Edit</button>



                         <a href="{{route('category.delete',$category->id)}}"><button type="button" class="btn btn-outline-primary">Delete</button>
